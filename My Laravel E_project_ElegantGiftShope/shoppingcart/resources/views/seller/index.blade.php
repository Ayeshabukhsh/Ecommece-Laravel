...
@section('seller')
<h3 class="mt-5">Dear Seller this is your Name: {{ Auth::guard('seller')->user()->name }}</h3><hr>
<h3>Dear Seller this is your Email: {{ Auth::guard('seller')->user()->email }}</h3>
{{-- <div class="w-75 mx-auto pt-5">
               ...
               <h1 class="mt-5 text-center" style="font-family: cursive">Dear Seller this is your Dashboard</h1>
               @endsection
