 ...
 @section('user')
   ...
   <div class="container-fluid bg-light py-3 my-6 mt-0">
            <div class="container text-center animated bounceInDown">
                <h1 class="display-1 ">STATIONARY</h1>
                <ol class="breadcrumb justify-content-center mb-0 animated bounceInDown">
                    <li class="breadcrumb-item"><a href="/">Home</a></li>
                   
                    <li class="breadcrumb-item text-dark" aria-current="page">Stationary</li>
                </ol>
            </div>
        </div>
        <!-- Hero End -->
        ...
        <div class="container-fluid">
            <img src="/img/stat.jpg" class='img-fluid'>
        </div><br><br><br><br>
		<div class="container">
				...
				{{-- <div class="col-lg-2 ">
					...
					<div class="row ">
						<div class="col-lg-12 col-sm-4 mt-5 bg-dark text-white p-3">
							<h2 id="category" class="text-white">Stationary Products</h2>
							...
							<form action="" id="categoryDetail">
								...
								<div class="form-check">
									...
									<label class="form-check-label">Erasers</label>
								</div><hr>
								<div class="form-check">
									<input type="checkbox" class="form-check-input" id="succulents" value="succulents">
									<label class="form-check-label">Ink pens</label>
								</div><hr>
								<div class="form-check">
									<input type="checkbox" class="form-check-input" id="flowering" value="flowering">
									<label class="form-check-label">Highlighter</label>
								</div><hr>
                                <div class="form-check">
									<input type="checkbox" class="form-check-input" id="flowering" value="flowering">
									<label class="form-check-label">pen set</label>
								</div><hr>
                                <div class="form-check">
									<input type="checkbox" class="form-check-input" id="flowering" value="flowering">
									<label class="form-check-label">Office file</label>
								</div><hr>
                                <div class="form-check">
									<input type="checkbox" class="form-check-input" id="flowering" value="flowering">
